...
% botSim.setBotPos([20,20],adminKey); %puts the robot in a random position at least 10cm away from a wall
% 
% botSim.setBotPos([30,20],adminKey); %puts the robot in a random position at least 10cm away from a wall
% target = [100,20];  %gets random target.
% 
botSim.setBotPos([50,70],adminKey); %puts the robot in a random position at least 10cm away from a wall
target = [230,70];  %gets random target.
